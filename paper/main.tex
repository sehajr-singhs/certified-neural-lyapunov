...
The certified closed loop uses the saturated linear droop law that she trains the
Lyapunov function against, so her Algorithm 2 stacked-ReLU RNN controller is not
reproduced here and the certificate is for the droop loop rather than for her
learned controller, and extending the certificate to the RNN loop is open.
